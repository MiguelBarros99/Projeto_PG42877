...
##### Data Load ##########
df = pd.read_csv('textfiles/Red_one_data.csv')
...
print('RFCV5')
RFCVcc=shallow_ml.ShallowML(X_train, X_test, y_train, y_test, report_name='rfcv5RedOne', columns_names=colnames)
...
print('RFCV10')
RFCVdez=shallow_ml.ShallowML(X_train, X_test, y_train, y_test, report_name='rfcv10RedOne', columns_names=colnames)
...
#
print('SVMCV10')
SVMCVdez = shallow_ml.ShallowML(X_train, X_test, y_train, y_test, report_name='svm10RedOne', columns_names=colnames)
...
print('SVMCV5')
SVMCVcc = shallow_ml.ShallowML(X_train, X_test, y_train, y_test, report_name='svm5RedOne', columns_names=colnames)
