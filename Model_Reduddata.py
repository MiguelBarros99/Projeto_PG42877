...
##### Data Load ##########
df = pd.read_csv('textfiles/Reduddata.csv')
# df = pd.read_csv('textfiles/Reduddata32.csv')
df.dropna()
...
dl = DeepML(x_train, y_train, x_test, y_test,
            ...
            path='saved_models/Redud', report_name='DNNRedud', verbose=1,  validation_split=0.1, shuffle=True, class_weights=None)
#
...
dl.roc_curve(classifier=dnn_simple, ylim=(0.0, 1.00), xlim=(0.0, 1.0),
                  title='ROC DNN Redud',
                  path_save='ROC_PLOT/DnnRedud.png', show=False, batch_size=None)
